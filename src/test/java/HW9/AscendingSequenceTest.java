...
public class AscendingSequenceTest {
    ...
    @Order(1)
//    @RepeatedTest(50) - если результат нестабилен
    @Test
    public void testAscendingSequenceHappyPathPositiveNumbers() {
        ...
        // HW9.AscendingSequence as = new HW9.AscendingSequence(); - повторяющийся код можно вынести в BeforeEach
    ...
    @Test
    public void testAscendingSequenceStartHigherThanEnd() {
        int start = 5;
        int end = 0;
        int step = 1;
        int[] expectedResult = {};
    ...
    @Test
    public void testAscendingSequenceNegativePositiveStepTwo() {
        int start = -5;
        int end = 5;
        int step = 2;
